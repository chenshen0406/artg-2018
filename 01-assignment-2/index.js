...
d3.csv('./data/hubway_trips_reduced.csv', parse, function(err,trips){
 ...
 //MODIFY THIS
	...
	***/
	...
	console.log(`Shortest trip duration is ${shortestDuration/3600}hours`);
	...
	***/
	...
	YOUR CODE HERE:
	***/
	const top10RegisteredTrips = registeredTrips.slice(0,10);//from first object to tenth object, won't include 11th object
	...
	***/
	console.log(registeredTrips);
	console.log(registeredTrips === top10RegisteredTrips);
	console.log(registeredTrips === bottom10RegisteredTrips);
	/** It behaves more like filter, as it create a entire new array.
	...
	YOUR CODE HERE:
	***/
	const departureTimestamps = trips.map(function(d){return d.t0});//IMPORTANT!!!!!!
