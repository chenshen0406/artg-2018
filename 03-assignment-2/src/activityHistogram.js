...
export default function activityHistogram(data){
	...
	const binsEnter = binsUpdate.enter()
		.append('rect')
		.attr('class','bin') //If you forget this, what will happen if we re-run this the activityHistogram function? The new bins will add to the old bins.
